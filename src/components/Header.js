...
class Header extends Component {
    ...
    $.ajax({
      ...
      success: function(myJSONResult) {
        if (myJSONResult.status === "OK") {
          for (
            var i = 0;
            i < myJSONResult.results[0].address_components.length;
            i++
          ) {
            if (
              myJSONResult.results[0].address_components[i].types[0] ===
              "postal_code"
            ) {
              window.sessionStorage.setItem(
                "location",
                myJSONResult.results[0].address_components[i].long_name.replace(
                  "-",
                  ""
                )
              );
  ...
  render() {
    ...
    if (this.props.location.pathname !== "/") {
      ...
      return (
        <section
          class="slider d-flex align-items-center"
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="slider-content_wrap">
                        ...
                        <h5 style={{ color: "#00A100", fontWeight: "bold" }}>
                          Eat tasty, Order Easily.
                        </h5>
                      </div>
                    </div>
                  </div>

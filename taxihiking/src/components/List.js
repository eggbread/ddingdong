      ...
      return (
        <div>
          <Navbar
            ...
            bg="light"
            expand="lg"
            style={{ borderBottom: "1px solid black", width: "100vw" }}
          >
            <Navbar.Brand style={{ color: "#60A186", fontWeight: "bold" }}>
              Category
            </Navbar.Brand>
            <Navbar.Toggle aria-controls="responsive-navbar-nav" />
            <Navbar.Collapse id="responsive-navbar-nav">
              <Nav className="mr-auto" style={{ textAlign: "center" }}>
                <Nav.Item style={{ marginRight: "50px", marginBottom: "10px" }}>
                  <Link
                    to={"/list/koreanfood/"}
            ...
            <TableBody>
              {this.state.storeList.map((item, index) => (
                <TableRow key={item.storename}>
                  ...
                  <TableCell className="listTable storeList" padding="none">
